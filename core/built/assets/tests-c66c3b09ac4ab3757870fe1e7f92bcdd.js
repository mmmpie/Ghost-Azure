                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 10:
                                ...
                                requestBody = $.deparam(refreshRequest.requestBody);
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            ...
                            case 9:
                                ...
                                (0, _chai.expect)(server.db.posts[0].custom_excerpt, 'saved excerpt after validation error').to.be.blank;
                            ...
                            case 15:
                                ...
                                (0, _chai.expect)(server.db.posts[0].custom_excerpt, 'saved excerpt').to.equal('Testing excerpt');
                            ...
                            case 23:
                                ...
                                (0, _chai.expect)(server.db.posts[0].codeinjection_head, 'saved header injection after validation error').to.be.blank;
                            ...
                            case 29:
                                ...
                                (0, _chai.expect)(server.db.posts[0].codeinjection_head, 'saved header injection').to.equal('<script src="http://example.com/inject-head.js"></script>');
                            ...
                            case 35:
                                ...
                                (0, _chai.expect)(server.db.posts[0].codeinjection_foot, 'saved footer injection after validation error').to.be.blank;
                            ...
                            case 41:
                                ...
                                (0, _chai.expect)(server.db.posts[0].codeinjection_foot, 'saved footer injection').to.equal('<script src="http://example.com/inject-foot.js"></script>');
                            ...
                            case 51:
                                ...
                                (0, _chai.expect)(server.db.posts[0].twitter_title, 'saved twitter title after validation error').to.be.blank;
                            ...
                            case 57:
                                ...
                                (0, _chai.expect)(server.db.posts[0].twitter_title, 'saved twitter title').to.equal('Test Twitter Title');
                            ...
                            case 62:
                                ...
                                (0, _chai.expect)(server.db.posts[0].twitter_description, 'saved twitter description after validation error').to.be.blank;
                            ...
                            case 68:
                                ...
                                (0, _chai.expect)(server.db.posts[0].twitter_description, 'saved twitter description').to.equal('Test Twitter Description');
                            ...
                            case 78:
                                ...
                                (0, _chai.expect)(server.db.posts[0].og_title, 'saved facebook title after validation error').to.be.blank;
                            ...
                            case 84:
                                ...
                                (0, _chai.expect)(server.db.posts[0].og_title, 'saved facebook title').to.equal('Test Facebook Title');
                            ...
                            case 89:
                                ...
                                (0, _chai.expect)(server.db.posts[0].og_description, 'saved facebook description after validation error').to.be.blank;
                            ...
                            case 95:
                                ...
                                (0, _chai.expect)(server.db.posts[0].og_description, 'saved facebook description').to.equal('Test Facebook Description');
...
define('ghost-admin/tests/acceptance/settings/design-test', ['ember-cli-mirage', 'ghost-admin/utils/ctrl-or-cmd', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/mirage/config/themes', 'ghost-admin/tests/helpers/start-app', 'mocha', 'ghost-admin/tests/helpers/ember-simple-auth', 'chai'], function (_emberCliMirage, _ctrlOrCmd, _destroyApp, _themes, _startApp, _mocha, _emberSimpleAuth, _chai) {
    ...
    (0, _mocha.describe)('Acceptance: Settings - Design', function () {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('clears unsaved settings when navigating away', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
                return regeneratorRuntime.wrap(function _callee6$(_context6) {
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
...
define('ghost-admin/tests/acceptance/settings/general-test', ['ghost-admin/utils/ctrl-or-cmd', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/mirage/config/uploads', 'ghost-admin/tests/helpers/start-app', 'ember-test-helpers/wait', 'mocha', 'ghost-admin/tests/helpers/ember-simple-auth', 'chai'], function (_ctrlOrCmd, _destroyApp, _uploads, _startApp, _wait, _mocha, _emberSimpleAuth, _chai) {
    ...
    (0, _mocha.describe)('Acceptance: Settings - General', function () {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('handles social blog settings correctly', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
                return regeneratorRuntime.wrap(function _callee7$(_context7) {
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            case 0:
                            ...
                            case 9:
                                ...
                                _context7.next = 12;
                                return fillIn('[data-test-facebook-input]', 'facebook.com/username');
                            ...
                            case 14:
                                ...
                                (0, _chai.expect)(find('[data-test-facebook-input]').val()).to.be.equal('https://www.facebook.com/username');
                                (0, _chai.expect)(find('[data-test-facebook-error]').text().trim(), 'inline validation response').to.equal('');

                                _context7.next = 18;
                                return fillIn('[data-test-facebook-input]', 'facebook.com/pages/some-facebook-page/857469375913?ref=ts');
                            ...
                            case 20:
                                ...
                                (0, _chai.expect)(find('[data-test-facebook-input]').val()).to.be.equal('https://www.facebook.com/pages/some-facebook-page/857469375913?ref=ts');
                                (0, _chai.expect)(find('[data-test-facebook-error]').text().trim(), 'inline validation response').to.equal('');

                                _context7.next = 24;
                                return fillIn('[data-test-facebook-input]', '*(&*(%%))');
                            ...
                            case 26:
                                ...
                                (0, _chai.expect)(find('[data-test-facebook-error]').text().trim(), 'inline validation response').to.equal('The URL must be in a format like https://www.facebook.com/yourPage');

                                _context7.next = 29;
                                return fillIn('[data-test-facebook-input]', 'http://github.com/username');
                            ...
                            case 31:
                                ...
                                _context7.next = 35;
                                return fillIn('[data-test-facebook-input]', 'http://github.com/pages/username');
                            ...
                            case 37:
                                ...
                                (0, _chai.expect)(find('[data-test-facebook-input]').val()).to.be.equal('https://www.facebook.com/pages/username');
                                (0, _chai.expect)(find('[data-test-facebook-error]').text().trim(), 'inline validation response').to.equal('');
                            ...
                            case 43:
                                ...
                                _context7.next = 47;
                                return fillIn('[data-test-facebook-input]', 'ab99');
                            ...
                            case 49:
                                ...
                                (0, _chai.expect)(find('[data-test-facebook-input]').val()).to.be.equal('https://www.facebook.com/ab99');
                                (0, _chai.expect)(find('[data-test-facebook-error]').text().trim(), 'inline validation response').to.equal('');

                                _context7.next = 53;
                                return fillIn('[data-test-facebook-input]', 'page/ab99');
                            ...
                            case 55:
                                ...
                                (0, _chai.expect)(find('[data-test-facebook-input]').val()).to.be.equal('https://www.facebook.com/page/ab99');
                                (0, _chai.expect)(find('[data-test-facebook-error]').text().trim(), 'inline validation response').to.equal('');

                                _context7.next = 59;
                                return fillIn('[data-test-facebook-input]', 'page/*(&*(%%))');
                            ...
                            case 61:
                                ...
                                (0, _chai.expect)(find('[data-test-facebook-input]').val()).to.be.equal('https://www.facebook.com/page/*(&*(%%))');
                                (0, _chai.expect)(find('[data-test-facebook-error]').text().trim(), 'inline validation response').to.equal('');
                            ...
                            case 68:
                                ...
                                _context7.next = 71;
                                return fillIn('[data-test-twitter-input]', 'twitter.com/username');
                            ...
                            case 73:
                                ...
                                (0, _chai.expect)(find('[data-test-twitter-input]').val()).to.be.equal('https://twitter.com/username');
                                (0, _chai.expect)(find('[data-test-twitter-error]').text().trim(), 'inline validation response').to.equal('');

                                _context7.next = 77;
                                return fillIn('[data-test-twitter-input]', '*(&*(%%))');
                            ...
                            case 79:
                                ...
                                (0, _chai.expect)(find('[data-test-twitter-error]').text().trim(), 'inline validation response').to.equal('The URL must be in a format like https://twitter.com/yourUsername');

                                _context7.next = 82;
                                return fillIn('[data-test-twitter-input]', 'http://github.com/username');
                            ...
                            case 84:
                                ...
                                _context7.next = 88;
                                return fillIn('[data-test-twitter-input]', 'thisusernamehasmorethan15characters');
                            ...
                            case 90:
                                ...
                                (0, _chai.expect)(find('[data-test-twitter-error]').text().trim(), 'inline validation response').to.equal('Your Username is not a valid Twitter Username');

                                _context7.next = 93;
                                return fillIn('[data-test-twitter-input]', 'testuser');
                            ...
                            case 95:
                                ...
                                (0, _chai.expect)(find('[data-test-twitter-input]').val()).to.be.equal('https://twitter.com/testuser');
                                (0, _chai.expect)(find('[data-test-twitter-error]').text().trim(), 'inline validation response').to.equal('');
...
define('ghost-admin/tests/acceptance/settings/tags-test', ['ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/start-app', 'ember-test-helpers/wait', 'ember-cli-mirage', 'mocha', 'ghost-admin/tests/helpers/ember-simple-auth', 'ghost-admin/tests/helpers/adapter-error', 'chai', 'ember-concurrency'], function (_destroyApp, _startApp, _wait, _emberCliMirage, _mocha, _emberSimpleAuth, _adapterError, _chai, _emberConcurrency) {
    ...
    (0, _mocha.describe)('Acceptance: Settings - Tags', function () {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('loads tag via slug when accessed directly', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                ...
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 22:
                                _context3.next = 24;
                                return fillIn('[data-test-password-input]', 'password');
        ...
        (0, _mocha.describe)('when attempting to signin', function () {
            (0, _mocha.beforeEach)(function () {
                ...
                server.post('/authentication/token', function (schema, _ref2) {
                    ...
                    var _$$deparam = $.deparam(requestBody),
    ...
    (0, _mocha.describe)('Acceptance: Team', function () {
        ...
        (0, _mocha.describe)('when logged in as admin', function () {
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            ...
                            case 4:
                                ...
                                (0, _chai.expect)('[data-test-suspended-badge]').to.exist;
            ...
            (0, _mocha.describe)('existing user', function () {
                ...
                (0, _mocha.it)('input fields reset and validate correctly', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
                    var _server$pretender$han, _server$pretender$han2, lastRequest, params, _server$pretender$han3, _server$pretender$han4, newRequest;
            ...
            (0, _mocha.describe)('own user', function () {
                (0, _mocha.it)('requires current password when changing password', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
                    return regeneratorRuntime.wrap(function _callee9$(_context9) {
                        while (1) {
                            switch (_context9.prev = _context9.next) {
                                case 0:
            ...
            (0, _mocha.it)('redirects to 404 when user does not exist', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
                return regeneratorRuntime.wrap(function _callee10$(_context10) {
                    while (1) {
                        switch (_context10.prev = _context10.next) {
                            case 0:
        ...
        (0, _mocha.describe)('when logged in as author', function () {
            ...
            (0, _mocha.it)('can access the team page', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
                return regeneratorRuntime.wrap(function _callee11$(_context11) {
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            case 0:
...
define('ghost-admin/tests/app.lint-test', [], function () {
  ...
  describe('ESLint | app', function () {
    ...
    it('components/modal-copy-html.js', function () {
      // test passed
    });
...
define('ghost-admin/tests/helpers/adapter-error', ['exports', 'ember-test'], function (exports, _emberTest) {
    'use strict';
...
define('ghost-admin/tests/helpers/editor-helpers', ['exports', 'ember-test-helpers/wait', 'mobiledoc-kit/renderers/mobiledoc', 'gh-koenig/components/gh-koenig', 'ember-native-dom-helpers'], function (exports, _wait, _mobiledoc, _ghKoenig, _emberNativeDomHelpers) {
    ...
    function titleRendered() {
        return Ember.Test.promise(function (resolve) {
            // eslint-disable-line
            function checkTitle() {
                var title = $('#koenig-title-input div');
                if (title[0]) {
                    return resolve();
                } else {
...
define('ghost-admin/tests/helpers/ember-power-calendar', ['exports', 'ember-test', 'ember-metal/utils', 'moment', 'ember-native-dom-helpers', 'ember-test-helpers/wait'], function (exports, _emberTest, _utils, _moment, _emberNativeDomHelpers, _wait) {
  'use strict';
  ...
  exports.default = function () {
    _emberTest.default.registerAsyncHelper('calendarCenter', function () {
    ...
    _emberTest.default.registerAsyncHelper('calendarSelect', function () {
...
define('ghost-admin/tests/helpers/file-upload', ['exports'], function (exports) {
    ...
    exports.default = registerAsyncHelper('fileUpload', function (app, selector, content, options) {
        var file = createFile(content, options);
...
define('ghost-admin/tests/helpers/start-app', ['exports', 'ghost-admin/app', 'ghost-admin/config/environment', 'ghost-admin/tests/helpers/file-upload', 'ghost-admin/tests/helpers/ember-power-datepicker', 'ghost-admin/tests/helpers/ember-power-select'], function (exports, _app, _environment, _fileUpload, _emberPowerDatepicker, _emberPowerSelect) {
    ...
    function startApp(attrs) {
        var attributes = assign({}, _environment.default.APP);
    ...
    (0, _mocha.describe)('Integration: Component: gh-alert', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "NhnKxqay",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-alert\",null,[[\"message\"],[[19,0,[\"message\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-alerts-test', ['mocha', 'chai', 'ember-mocha'], function (_mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-alerts', function () {
        ...
        (0, _mocha.it)('triggers "notify" action when message count changes', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "4RTIlLki",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-alerts\",null,[[\"notify\"],[[25,\"action\",[[19,0,[]],[19,0,[\"notify\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-basic-dropdown-test', ['ghost-admin/tests/helpers/ember-basic-dropdown', 'mocha', 'chai', 'ember-native-dom-helpers', 'ember-mocha'], function (_emberBasicDropdown, _mocha, _chai, _emberNativeDomHelpers, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-basic-dropdown', function () {
        ...
        (0, _mocha.it)('closes when dropdown service fires close event', function () {
            ...
            (0, _chai.expect)($((0, _emberNativeDomHelpers.find)('#dropdown-is-opened'))).to.exist;

            run(function () {
                dropdownService.closeDropdowns();
            });

            (0, _chai.expect)($((0, _emberNativeDomHelpers.find)('#dropdown-is-opened'))).to.not.exist;
        });
    });
});
define('ghost-admin/tests/integration/components/gh-cm-editor-test', ['ember-test-helpers/wait', 'ember-native-dom-helpers', 'mocha', 'chai', 'ember-mocha'], function (_wait, _emberNativeDomHelpers, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-cm-editor', function () {
        ...
        (0, _mocha.it)('handles change event', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "l9TRVM1p",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-cm-editor\",[[19,0,[\"text\"]]],[[\"class\",\"update\"],[\"gh-input\",[25,\"action\",[[19,0,[]],[25,\"mut\",[[19,0,[\"text\"]]],null]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('handles focus event', function (done) {
            ...
            var onFocus = function onFocus() {
                ...
                (0, _wait.default)().then(function () {
                    (0, _chai.expect)($((0, _emberNativeDomHelpers.find)('.gh-input')).hasClass('focus'), 'has focused class on first render with autofocus').to.be.true;
            ...
            this.render(Ember.HTMLBars.template({
                "id": "Ehvno/f9",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-cm-editor\",[[19,0,[\"text\"]]],[[\"class\",\"update\",\"focus-in\"],[\"gh-input\",[25,\"action\",[[19,0,[]],[25,\"mut\",[[19,0,[\"text\"]]],null]],null],[25,\"action\",[[19,0,[]],[19,0,[\"onFocus\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            (0, _chai.expect)($((0, _emberNativeDomHelpers.find)('.gh-input')).hasClass('focus')).to.be.false;
                        ...
                        case 7:
                            ...
                            (0, _chai.expect)($((0, _emberNativeDomHelpers.find)('.gh-input')).hasClass('focus')).to.be.true;
        ...
        (0, _mocha.it)('can autofocus', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "64kvQulK",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-cm-editor\",[[19,0,[\"text\"]]],[[\"class\",\"update\",\"autofocus\",\"focus-in\"],[\"gh-input\",[25,\"action\",[[19,0,[]],[25,\"mut\",[[19,0,[\"text\"]]],null]],null],true,[25,\"action\",[[19,0,[]],[19,0,[\"onFocus\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        });
    });
...
define('ghost-admin/tests/integration/components/gh-file-uploader-test', ['pretender', 'sinon', 'ember-test-helpers/wait', 'ghost-admin/services/ajax', 'ghost-admin/tests/helpers/file-upload', 'mocha', 'chai', 'ember-mocha'], function (_pretender, _sinon, _wait, _ajax, _fileUpload, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-file-uploader', function () {
        ...
        (0, _mocha.it)('renders form with supplied label text', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "sK+u1NZk",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"labelText\"],[[19,0,[\"labelText\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('generates request to supplied endpoint', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "8H/J/uZR",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\"],[[19,0,[\"uploadUrl\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('fires uploadSuccess action on successful upload', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "x3oKsDc4",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"uploadSuccess\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.csv' });
        ...
        (0, _mocha.it)('fires fileSelected action on file selection', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "+tjghAu2",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"fileSelected\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"fileSelected\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.csv' });
        ...
        (0, _mocha.it)('fires uploadStarted action on upload start', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "2x6n/6Ve",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"uploadStarted\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadStarted\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.csv' });
        ...
        (0, _mocha.it)('fires uploadFinished action on successful upload', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "SDyaQhhG",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"uploadFinished\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFinished\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.csv' });
        ...
        (0, _mocha.it)('displays upload progress', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "KJ2xC6rC",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"uploadFinished\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"done\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.csv' });
        ...
        (0, _mocha.it)('validates extension by default', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "9eudvlAg",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"uploadSuccess\",\"uploadFailed\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFailed\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('uploads if validate action supplied and returns true', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "TOc/EEu5",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"uploadSuccess\",\"validate\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"validate\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('skips upload and displays error if validate action supplied and doesn\'t return true', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "gSIkLriR",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-file-uploader\",null,[[\"url\",\"uploadSuccess\",\"uploadFailed\",\"validate\"],[[19,0,[\"uploadUrl\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFailed\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"validate\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-image-uploader-test', ['pretender', 'sinon', 'ember-test-helpers/wait', 'ghost-admin/services/ajax', 'ghost-admin/tests/helpers/file-upload', 'mocha', 'chai', 'ember-mocha'], function (_pretender, _sinon, _wait, _ajax, _fileUpload, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-image-uploader', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "J4O+YrdG",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\"],[[19,0,[\"image\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
        ...
        (0, _mocha.it)('renders form with supplied alt text', function () {
            this.render(Ember.HTMLBars.template({
                "id": "EjMWakcE",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\",\"altText\"],[[19,0,[\"image\"]],\"text test\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('renders form with supplied text', function () {
            this.render(Ember.HTMLBars.template({
                "id": "KyaYbyaJ",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\",\"text\"],[[19,0,[\"image\"]],\"text test\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('generates request to correct endpoint', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "2CJY0Rdg",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\",\"update\"],[[19,0,[\"image\"]],[25,\"action\",[[19,0,[]],[19,0,[\"update\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('fires fileSelected action on file selection', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "Co+Ztn93",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\",\"fileSelected\",\"update\"],[[19,0,[\"image\"]],[25,\"action\",[[19,0,[]],[19,0,[\"fileSelected\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"update\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.png' });
        ...
        (0, _mocha.it)('fires uploadStarted action on upload start', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "ejGXP64o",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\",\"uploadStarted\",\"update\"],[[19,0,[\"image\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadStarted\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"update\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.png' });
        ...
        (0, _mocha.it)('fires uploadFinished action on successful upload', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "dhTlT9UO",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\",\"uploadFinished\",\"update\"],[[19,0,[\"image\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFinished\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"update\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.png' });
        ...
        (0, _mocha.it)('displays upload progress', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "nTK6cR5r",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"image\",\"uploadFinished\",\"update\"],[[19,0,[\"image\"]],[25,\"action\",[[19,0,[]],[19,0,[\"done\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"update\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _fileUpload.fileUpload)(this.$('input[type="file"]'), ['test'], { name: 'test.png' });
        ...
        (0, _mocha.it)('triggers file upload on file drop', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "wIH9K9qk",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"uploadSuccess\"],[[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('validates extension by default', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "n/WSz8Ly",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"uploadSuccess\",\"uploadFailed\"],[[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFailed\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('uploads if validate action supplied and returns true', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "AZ4u9LM1",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"uploadSuccess\",\"validate\"],[[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"validate\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('skips upload and displays error if validate action supplied and doesn\'t return true', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "1gJa8kYJ",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader\",null,[[\"uploadSuccess\",\"uploadFailed\",\"validate\"],[[25,\"action\",[[19,0,[]],[19,0,[\"uploadSuccess\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFailed\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"validate\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-image-uploader-with-preview-test', ['sinon', 'mocha', 'chai', 'ember-mocha'], function (_sinon, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-image-uploader-with-preview', function () {
        ...
        (0, _mocha.it)('renders image if provided', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "JG7YVQ0N",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader-with-preview\",null,[[\"image\"],[[19,0,[\"image\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('triggers remove action when delete icon is clicked', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "hxhHXp1T",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-image-uploader-with-preview\",null,[[\"image\",\"remove\"],[[19,0,[\"image\"]],[25,\"action\",[[19,0,[]],[19,0,[\"remove\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            run(function () {
...
define('ghost-admin/tests/integration/components/gh-navigation-test', ['ghost-admin/models/navigation-item', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha'], function (_navigationItem, _wait, _mocha, _chai, _emberMocha) {
    'use strict';
    ...
    (0, _mocha.describe)('Integration: Component: gh-navigation', function () {
        ...
        (0, _mocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template({
                "id": "L7OppP/B",
                "block": "{\"symbols\":[],\"statements\":[[4,\"gh-navigation\",null,null,{\"statements\":[[6,\"div\"],[9,\"class\",\"js-gh-blognav\"],[7],[6,\"div\"],[9,\"class\",\"gh-blognav-item\"],[7],[8],[8]],\"parameters\":[]},null]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('triggers reorder action', function () {
            ...
            run(function () {
                _this.render(Ember.HTMLBars.template({
                    "id": "q6lT3OHl",
                    "block": "{\"symbols\":[\"navItem\"],\"statements\":[[0,\"\\n\"],[4,\"gh-navigation\",null,[[\"moveItem\"],[\"moveItem\"]],{\"statements\":[[0,\"                \"],[6,\"form\"],[9,\"id\",\"settings-navigation\"],[9,\"class\",\"gh-blognav js-gh-blognav\"],[9,\"novalidate\",\"novalidate\"],[7],[0,\"\\n\"],[4,\"each\",[[19,0,[\"navigationItems\"]]],null,{\"statements\":[[0,\"                        \"],[1,[25,\"gh-navitem\",null,[[\"navItem\",\"baseUrl\",\"addItem\",\"deleteItem\",\"updateUrl\"],[[19,1,[]],[19,0,[\"blogUrl\"]],\"addItem\",\"deleteItem\",\"updateUrl\"]]],false],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"                \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}",
                    "meta": {}
                }));
            });
...
define('ghost-admin/tests/integration/components/gh-navitem-test', ['ghost-admin/models/navigation-item', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha'], function (_navigationItem, _wait, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-navitem', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "3gUUWtyh",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-navitem\",null,[[\"navItem\",\"baseUrl\"],[[19,0,[\"navItem\"]],[19,0,[\"baseUrl\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('triggers delete action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "9yMRY5vs",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-navitem\",null,[[\"navItem\",\"baseUrl\",\"deleteItem\"],[[19,0,[\"navItem\"]],[19,0,[\"baseUrl\"]],\"deleteItem\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('triggers add action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "7xj6XGLb",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-navitem\",null,[[\"navItem\",\"baseUrl\",\"addItem\"],[[19,0,[\"navItem\"]],[19,0,[\"baseUrl\"]],\"add\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('triggers update action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "iZe3Zpy2",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-navitem\",null,[[\"navItem\",\"baseUrl\",\"updateUrl\"],[[19,0,[\"navItem\"]],[19,0,[\"baseUrl\"]],\"update\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-navitem-url-input-test', ['mocha', 'chai', 'ember-mocha'], function (_mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-navitem-url-input', function () {
        ...
        (0, _mocha.it)('renders correctly with blank url', function () {
            this.render(Ember.HTMLBars.template({
                "id": "WAEp67PZ",
                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n            \"],[1,[25,\"gh-navitem-url-input\",null,[[\"baseUrl\",\"url\",\"isNew\",\"change\",\"clearErrors\"],[[19,0,[\"baseUrl\"]],[19,0,[\"url\"]],[19,0,[\"isNew\"]],\"updateUrl\",[25,\"action\",[[19,0,[]],\"clearErrors\"],null]]]],false],[0,\"\\n        \"]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-notification-test', ['mocha', 'chai', 'ember-mocha'], function (_mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-notification', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "n+M0EIBA",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-notification\",null,[[\"message\"],[[19,0,[\"message\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-profile-image-test', ['pretender', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha', 'ember-concurrency'], function (_pretender, _wait, _mocha, _chai, _emberMocha, _emberConcurrency) {
    ...
    var configStubuseGravatar = Service.extend({
        useGravatar: true
    });
    ...
    (0, _mocha.describe)('Integration: Component: gh-profile-image', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "2ePQpEyX",
                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n            \"],[1,[25,\"gh-profile-image\",null,[[\"email\"],[[19,0,[\"email\"]]]]],false],[0,\"\\n        \"]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('renders default image if no email supplied', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "Ngym0xTG",
                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n            \"],[1,[25,\"gh-profile-image\",null,[[\"email\",\"size\",\"debounce\"],[[19,0,[\"email\"]],100,50]]],false],[0,\"\\n        \"]],\"hasEval\":false}",
                "meta": {}
            }));
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            this.render(Ember.HTMLBars.template({
                                "id": "xs+aNjFJ",
                                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n            \"],[1,[25,\"gh-profile-image\",null,[[\"email\",\"size\",\"debounce\"],[[19,0,[\"email\"]],100,300]]],false],[0,\"\\n        \"]],\"hasEval\":false}",
                                "meta": {}
                            }));
...
define('ghost-admin/tests/integration/components/gh-publishmenu-test', ['mocha', 'chai', 'ember-mocha', 'ghost-admin/initializers/ember-cli-mirage'], function (_mocha, _chai, _emberMocha, _emberCliMirage) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-publishmenu', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "4KelpJlW",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-publishmenu\",null,[[\"post\"],[[19,0,[\"post\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-subscribers-table-test', ['ember-light-table', 'mocha', 'chai', 'ember-mocha'], function (_emberLightTable, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-subscribers-table', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "dcoPq3MN",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-subscribers-table\",null,[[\"table\",\"sortByColumn\",\"delete\"],[[19,0,[\"table\"]],[25,\"action\",[[19,0,[]],[19,0,[\"sortByColumn\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"delete\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-tag-settings-form-test', ['ember-data', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha'], function (_emberData, _wait, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-tag-settings-form', function () {
        ...
        (0, _mocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template({
                "id": "kdG9S9ep",
                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n            \"],[1,[25,\"gh-tag-settings-form\",null,[[\"tag\",\"setProperty\"],[[19,0,[\"tag\"]],[25,\"action\",[[19,0,[]],\"setProperty\"],null]]]],false],[0,\"\\n        \"]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
        ...
        (0, _mocha.it)('resets if a new tag is received', function () {
            ...
            run(function () {
                _this8.set('tag', EmberObject.create({ id: '2' }));
            });
        ...
        (0, _mocha.it)('triggers delete tag modal on delete click', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "J7htcl0V",
                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n            \"],[1,[25,\"gh-tag-settings-form\",null,[[\"tag\",\"setProperty\",\"showDeleteTagModal\"],[[19,0,[\"tag\"]],[25,\"action\",[[19,0,[]],\"setProperty\"],null],[25,\"action\",[[19,0,[]],\"openModal\"],null]]]],false],[0,\"\\n        \"]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-tags-management-container-test', ['mocha', 'chai', 'ember-mocha'], function (_mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-tags-management-container', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "ApK4/KOt",
                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n            \"],[4,\"gh-tags-management-container\",null,[[\"tags\",\"selectedTag\",\"enteredMobile\",\"leftMobile\"],[[19,0,[\"tags\"]],[19,0,[\"selectedTag\"]],\"enteredMobile\",\"leftMobile\"]],{\"statements\":[],\"parameters\":[]},null],[0,\"\\n        \"]],\"hasEval\":false}",
                "meta": {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-task-button-test', ['ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha', 'ember-concurrency'], function (_wait, _mocha, _chai, _emberMocha, _emberConcurrency) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-task-button', function () {
        ...
        (0, _mocha.it)('shows spinner whilst running', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "iLiAP/op",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-task-button\",null,[[\"task\"],[[19,0,[\"myTask\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('shows running text when passed whilst running', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "6APx4V+T",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-task-button\",null,[[\"task\",\"runningText\"],[[19,0,[\"myTask\"]],\"Running\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('assigns specified success class on success', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "1800fVm8",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-task-button\",null,[[\"task\",\"successClass\"],[[19,0,[\"myTask\"]],\"im-a-success\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('assigns specified failure class on failure', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "IgbDzwN2",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-task-button\",null,[[\"task\",\"failureClass\"],[[19,0,[\"myTask\"]],\"im-a-failure\"]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-theme-table-test', ['sinon', 'mocha', 'chai', 'ember-mocha'], function (_sinon, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-theme-table', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "KuTc2l3m",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-theme-table\",null,[[\"themes\",\"activateTheme\",\"downloadTheme\",\"deleteTheme\"],[[19,0,[\"themes\"]],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('delete link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "nHEstsWI",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-theme-table\",null,[[\"themes\",\"activateTheme\",\"downloadTheme\",\"deleteTheme\"],[[19,0,[\"themes\"]],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"deleteAction\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('download link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "c79R9I//",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-theme-table\",null,[[\"themes\",\"activateTheme\",\"downloadTheme\",\"deleteTheme\"],[[19,0,[\"themes\"]],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"downloadAction\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('activate link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "JXgHZ5BP",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-theme-table\",null,[[\"themes\",\"activateTheme\",\"downloadTheme\",\"deleteTheme\"],[[19,0,[\"themes\"]],[25,\"action\",[[19,0,[]],[19,0,[\"activateAction\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"actionHandler\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-timezone-select-test', ['sinon', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha'], function (_sinon, _wait, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-timezone-select', function () {
        ...
        (0, _mocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template({
                "id": "HXe33S8g",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-timezone-select\",null,[[\"availableTimezones\",\"activeTimezone\"],[[19,0,[\"availableTimezones\"]],[19,0,[\"activeTimezone\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('triggers update action on change', function (done) {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "06J7PmWK",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-timezone-select\",null,[[\"availableTimezones\",\"activeTimezone\",\"update\"],[[19,0,[\"availableTimezones\"]],[19,0,[\"activeTimezone\"]],[25,\"action\",[[19,0,[]],[19,0,[\"update\"]]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-trim-focus-input-test', ['mocha', 'chai', 'ember-mocha'], function (_mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-trim-focus-input', function () {
        ...
        (0, _mocha.it)('trims value on focusOut', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "lYHe4I6j",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-trim-focus-input\",[[19,0,[\"text\"]]],[[\"update\"],[[25,\"action\",[[19,0,[]],[25,\"mut\",[[19,0,[\"text\"]]],null]],null]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('does not have the autofocus attribute if not set to focus', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "rD5gW1YF",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-trim-focus-input\",[[19,0,[\"text\"]]],[[\"shouldFocus\"],[false]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
        ...
        (0, _mocha.it)('has the autofocus attribute if set to focus', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "zoXaWNU6",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-trim-focus-input\",[[19,0,[\"text\"]]],[[\"shouldFocus\"],[true]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
...
define('ghost-admin/tests/integration/components/gh-unsplash-photo-test', ['mocha', 'chai', 'ember-native-dom-helpers', 'ember-mocha'], function (_mocha, _chai, _emberNativeDomHelpers, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-unsplash-photo', function () {
        ...
        (0, _mocha.it)('sets background-color style', function () {
            this.render(Ember.HTMLBars.template({
                "id": "8tDWa1W2",
                "block": "{\"symbols\":[],\"statements\":[[1,[25,\"gh-unsplash-photo\",null,[[\"photo\"],[[19,0,[\"photo\"]]]]],false]],\"hasEval\":false}",
                "meta": {}
            }));
    ...
    (0, _mocha.describe)('Integration: Component: gh-uploader', function () {
        ...
        (0, _mocha.describe)('uploads', function () {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                this.render(Ember.HTMLBars.template({
                                    "id": "whOVowVA",
                                    "block": "{\"symbols\":[],\"statements\":[[4,\"gh-uploader\",null,[[\"files\"],[[19,0,[\"files\"]]]],{\"statements\":[],\"parameters\":[]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "2NIgPVan",
                                    "block": "{\"symbols\":[],\"statements\":[[4,\"gh-uploader\",null,[[\"files\",\"onStart\"],[[19,0,[\"files\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadStarted\"]]],null]]],{\"statements\":[],\"parameters\":[]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)(), (0, _fileUpload.createFile)()]);
                                _context3.next = 5;
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "x+9B2vlu",
                                    "block": "{\"symbols\":[],\"statements\":[[4,\"gh-uploader\",null,[[\"files\",\"onUploadSuccess\"],[[19,0,[\"files\"]],[25,\"action\",[[19,0,[]],[19,0,[\"fileUploaded\"]]],null]]],{\"statements\":[],\"parameters\":[]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "9LUgGWVr",
                                    "block": "{\"symbols\":[],\"statements\":[[4,\"gh-uploader\",null,[[\"files\",\"onComplete\"],[[19,0,[\"files\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadsFinished\"]]],null]]],{\"statements\":[],\"parameters\":[]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                    ...
                    while (1) {
                        switch (_context9.prev = _context9.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "8vGU/Rwb",
                                    "block": "{\"symbols\":[\"uploader\"],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\"],[[19,0,[\"files\"]]]],{\"statements\":[[4,\"if\",[[19,1,[\"isUploading\"]]],null,{\"statements\":[[0,\"                    \"],[6,\"div\"],[9,\"class\",\"is-uploading-test\"],[7],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[1]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                    ...
                    while (1) {
                        switch (_context10.prev = _context10.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "rAe2MqHK",
                                    "block": "{\"symbols\":[\"uploader\"],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\"],[[19,0,[\"files\"]]]],{\"statements\":[[0,\"                \"],[1,[19,1,[\"progressBar\"]],false],[0,\"\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
            ...
            (0, _mocha.it)('yields files property', function () {
                this.render(Ember.HTMLBars.template({
                    "id": "r9CExpve",
                    "block": "{\"symbols\":[\"uploader\",\"file\"],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\"],[[19,0,[\"files\"]]]],{\"statements\":[[4,\"each\",[[19,1,[\"files\"]]],null,{\"statements\":[[0,\"                    \"],[6,\"div\"],[9,\"class\",\"file\"],[7],[1,[19,2,[\"name\"]],false],[8],[0,\"\\n\"]],\"parameters\":[2]},null]],\"parameters\":[1]},null]],\"hasEval\":false}",
                    "meta": {}
                }));
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "C4ntHUKL",
                                    "block": "{\"symbols\":[\"uploader\"],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\",\"onCancel\"],[[19,0,[\"files\"]],[25,\"action\",[[19,0,[]],[19,0,[\"cancelled\"]]],null]]],{\"statements\":[[0,\"                \"],[6,\"button\"],[9,\"class\",\"cancel-button\"],[3,\"action\",[[19,0,[]],[19,1,[\"cancel\"]]]],[7],[0,\"Cancel\"],[8],[0,\"\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                    ...
                    while (1) {
                        switch (_context12.prev = _context12.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "RIUnGpAi",
                                    "block": "{\"symbols\":[],\"statements\":[[4,\"gh-uploader\",null,[[\"files\",\"uploadUrl\"],[[19,0,[\"files\"]],\"/images/\"]],{\"statements\":[],\"parameters\":[]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)()]);
                                _context12.next = 5;
                    ...
                    while (1) {
                        switch (_context13.prev = _context13.next) {
                            case 0:
                                this.render(Ember.HTMLBars.template({
                                    "id": "Vg5qDTcj",
                                    "block": "{\"symbols\":[],\"statements\":[[4,\"gh-uploader\",null,[[\"files\",\"paramName\"],[[19,0,[\"files\"]],\"testupload\"]],{\"statements\":[],\"parameters\":[]},null]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)()]);
                                _context13.next = 4;
                    ...
                    while (1) {
                        switch (_context14.prev = _context14.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "LgGTW6uR",
                                    "block": "{\"symbols\":[],\"statements\":[[0,\"\\n                \"],[4,\"gh-uploader\",null,[[\"files\",\"extensions\",\"onFailed\"],[[19,0,[\"files\"]],\"jpg,jpeg\",[25,\"action\",[[19,0,[]],[19,0,[\"onFailed\"]]],null]]],{\"statements\":[],\"parameters\":[]},null],[0,\"\\n            \"]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                    ...
                    while (1) {
                        switch (_context15.prev = _context15.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "5sxdBwQX",
                                    "block": "{\"symbols\":[],\"statements\":[[0,\"\\n                \"],[4,\"gh-uploader\",null,[[\"files\",\"validate\",\"onFailed\"],[[19,0,[\"files\"]],[25,\"action\",[[19,0,[]],[19,0,[\"validate\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"onFailed\"]]],null]]],{\"statements\":[],\"parameters\":[]},null],[0,\"\\n            \"]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)(['test'], { name: 'test.png' })]);
                                _context15.next = 6;
                    ...
                    while (1) {
                        switch (_context16.prev = _context16.next) {
                            case 0:
                                this.render(Ember.HTMLBars.template({
                                    "id": "cF6CSnK2",
                                    "block": "{\"symbols\":[\"uploader\",\"error\"],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\",\"extensions\"],[[19,0,[\"files\"]],\"jpg,jpeg\"]],{\"statements\":[[4,\"each\",[[19,1,[\"errors\"]]],null,{\"statements\":[[0,\"                        \"],[6,\"div\"],[9,\"class\",\"error-fileName\"],[7],[1,[19,2,[\"fileName\"]],false],[8],[0,\"\\n                        \"],[6,\"div\"],[9,\"class\",\"error-message\"],[7],[1,[19,2,[\"message\"]],false],[8],[0,\"\\n\"]],\"parameters\":[2]},null]],\"parameters\":[1]},null],[0,\"            \"]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)(['test'], { name: 'test.png' })]);
                                _context16.next = 4;
                    ...
                    while (1) {
                        switch (_context17.prev = _context17.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "ZLAGD1q4",
                                    "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\",\"onFailed\",\"onComplete\"],[[19,0,[\"files\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFailed\"]]],null],[25,\"action\",[[19,0,[]],[19,0,[\"uploadComplete\"]]],null]]],{\"statements\":[],\"parameters\":[]},null],[0,\"            \"]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)(['test'], { name: 'file1.png' }), (0, _fileUpload.createFile)(['test'], { name: 'file2.png' })]);
                                _context17.next = 6;
                    ...
                    while (1) {
                        switch (_context18.prev = _context18.next) {
                            case 0:
                                ...
                                this.render(Ember.HTMLBars.template({
                                    "id": "uoOMLQ1O",
                                    "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\",\"onUploadFailure\"],[[19,0,[\"files\"]],[25,\"action\",[[19,0,[]],[19,0,[\"uploadFail\"]]],null]]],{\"statements\":[],\"parameters\":[]},null],[0,\"            \"]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)(['test'], { name: 'file1.png' }), (0, _fileUpload.createFile)(['test'], { name: 'file2.png' })]);
                                _context18.next = 5;
                    ...
                    while (1) {
                        switch (_context19.prev = _context19.next) {
                            case 0:
                                this.render(Ember.HTMLBars.template({
                                    "id": "jRKx4OSf",
                                    "block": "{\"symbols\":[\"uploader\",\"error\"],\"statements\":[[0,\"\\n\"],[4,\"gh-uploader\",null,[[\"files\"],[[19,0,[\"files\"]]]],{\"statements\":[[4,\"each\",[[19,1,[\"errors\"]]],null,{\"statements\":[[0,\"                        \"],[6,\"div\"],[9,\"class\",\"error-fileName\"],[7],[1,[19,2,[\"fileName\"]],false],[8],[0,\"\\n                        \"],[6,\"div\"],[9,\"class\",\"error-message\"],[7],[1,[19,2,[\"message\"]],false],[8],[0,\"\\n\"]],\"parameters\":[2]},null]],\"parameters\":[1]},null],[0,\"            \"]],\"hasEval\":false}",
                                    "meta": {}
                                }));
                                this.set('files', [(0, _fileUpload.createFile)(['test'], { name: 'test.png' })]);
                                _context19.next = 4;
...
define('ghost-admin/tests/integration/components/gh-validation-status-container-test', ['ember-data', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha'], function (_emberData, _wait, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-validation-status-container', function () {
        ...
        (0, _mocha.it)('has no success/error class by default', function () {
            ...
            this.render(Ember.HTMLBars.template({
                "id": "4unWeZfD",
                "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"gh-validation-status-container\",null,[[\"class\",\"property\",\"errors\",\"hasValidated\"],[\"gh-test\",\"name\",[19,0,[\"testObject\",\"errors\"]],[19,0,[\"testObject\",\"hasValidated\"]]]],{\"statements\":[],\"parameters\":[]},null],[0,\"        \"]],\"hasEval\":false}",
                "meta": {}
            }));
    ...
    (0, _mocha.describe)('Integration: Service: lazy-loader', function () {
        ...
        (0, _mocha.it)('loads styles correctly', function () {
            ...
            return subject.loadStyle('testing', 'style.css').catch(function () {
                ...
                (0, _chai.expect)($('#testing-styles').length).to.equal(1);
                (0, _chai.expect)($('#testing-styles').attr('href')).to.equal('/assets/style.css');
            });
        });
    });
});
...
define('ghost-admin/tests/unit/components/gh-selectize-test', ['mocha', 'chai', 'ember-mocha'], function (_mocha, _chai, _emberMocha) {
    'use strict';
...
define('ghost-admin/tests/unit/helpers/gh-format-post-time-test', ['moment', 'sinon', 'mocha', 'chai', 'ember-mocha'], function (_moment, _sinon, _mocha, _chai, _emberMocha) {
    ...
    // because why not?
    var timezoneForTest = 'Iceland'; /* jshint expr:true */
...
define('ghost-admin/tests/unit/mixins/editor-base-controller-test', ['ghost-admin/mixins/editor-base-controller', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-concurrency'], function (_editorBaseController, _wait, _mocha, _chai, _emberConcurrency) {
    'use strict';
    ...
    (0, _mocha.describe)('Unit: Mixin: editor-base-controller', function () {
        (0, _mocha.describe)('generateSlug', function () {
            (0, _mocha.it)('should generate a slug and set it on the model', function (done) {
                ...
                run(function () {
                    object = EmberObject.extend(_editorBaseController.default, {
                        slugGenerator: EmberObject.create({
                            generateSlug: function generateSlug(slugType, str) {
...
define('ghost-admin/tests/unit/models/post-test', ['mocha', 'ember-mocha'], function (_mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Unit: Model: post', function () {
        ...
        (0, _mocha.it)('isAuthoredByUser is correct', function () {
            ...
            var user = EmberObject.create({ id: 'abcd1234' });
...
define('ghost-admin/tests/unit/services/notifications-test', ['sinon', 'ember-ajax/errors', 'ghost-admin/services/ajax', 'mocha', 'chai', 'ember-mocha'], function (_sinon, _errors, _ajax, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Unit: Service: notifications', function () {
        ...
        (0, _mocha.it)('#showAPIError handles single json response error', function () {
            ...
            (0, _chai.expect)(get(alert, 'message')).to.equal('Single error');
            (0, _chai.expect)(get(alert, 'status')).to.equal('alert');
            (0, _chai.expect)(get(alert, 'type')).to.equal('error');
            (0, _chai.expect)(get(alert, 'key')).to.equal('api-error');
        });
        ...
        (0, _mocha.it)('#showAPIError parses default ember-ajax errors correctly', function () {
            ...
            (0, _chai.expect)(get(notification, 'message')).to.equal('Request was rejected because it was invalid');
            (0, _chai.expect)(get(notification, 'status')).to.equal('alert');
            (0, _chai.expect)(get(notification, 'type')).to.equal('error');
            (0, _chai.expect)(get(notification, 'key')).to.equal('api-error.ajax-error');
        });
        ...
        (0, _mocha.it)('#showAPIError parses custom ember-ajax errors correctly', function () {
            ...
            var notification = notifications.get('alerts.firstObject');
            (0, _chai.expect)(get(notification, 'message')).to.equal('Server was unreachable');
            (0, _chai.expect)(get(notification, 'status')).to.equal('alert');
            (0, _chai.expect)(get(notification, 'type')).to.equal('error');
            (0, _chai.expect)(get(notification, 'key')).to.equal('api-error.ajax-error');
        });
...
define('ghost-admin/tests/unit/transforms/navigation-settings-test', ['ghost-admin/models/navigation-item', 'mocha', 'chai', 'ember-mocha'], function (_navigationItem, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Unit: Transform: navigation-settings', function () {
        ...
        (0, _mocha.it)('serializes array of NavigationItems', function () {
            var transform = this.subject();
            var deserialized = emberA([_navigationItem.default.create({ label: 'One', url: '/one' }), _navigationItem.default.create({ label: 'Two', url: '/two' })]);
            var result = transform.serialize(deserialized);
...
define('ghost-admin/tests/unit/transforms/slack-settings-test', ['ghost-admin/models/slack-integration', 'mocha', 'chai', 'ember-mocha'], function (_slackIntegration, _mocha, _chai, _emberMocha) {
    ...
    (0, _mocha.describe)('Unit: Transform: slack-settings', function () {
        ...
        (0, _mocha.it)('serializes array of Slack settings', function () {
            var transform = this.subject();
            var deserialized = emberA([_slackIntegration.default.create({ url: 'http://myblog.com/blogpost1' })]);
            var result = transform.serialize(deserialized);
...
define('ghost-admin/tests/unit/validators/tag-settings-test', ['ghost-admin/mixins/validation-engine', 'mocha', 'chai'], function (_validationEngine, _mocha, _chai) {
    ...
    var Tag = EmberObject.extend(_validationEngine.default, {
        validationType: 'tag',
...
//# sourceMappingURL=tests-4a18521244d046db90934e247e261463.map
